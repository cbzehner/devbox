{ config, pkgs, ... }: {
  ...
  # TODO: Pass in hostName as variable (see https://discourse.nixos.org/t/variables-for-a-system/2342/12)
  networking.hostName = "commitracer";
  ...
  environment.systemPackages = with pkgs; [ neovim mosh ];
